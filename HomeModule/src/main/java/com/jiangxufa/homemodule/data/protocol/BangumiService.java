...
import com.jiangxufa.homemodule.model.bandumi.BangumiDetailRecommend;
...
//
    ...
    Observable<HttpResponse<BangumiDetailRecommend>> getBangumiDetailRecommend();
    ...
    Observable<HttpResponse<BangumiDetail>> getBangumiDetail();
}
